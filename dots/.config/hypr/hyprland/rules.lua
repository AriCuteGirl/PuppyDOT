...
hl.window_rule({match = {class = "^(hyprland-cheatsheet)$" },                float = true})
hl.window_rule({match = {class = "^(hyprland-cheatsheet)$" },                size = {"(monitor_w*0.72)", "(monitor_h*0.78)"} })
hl.window_rule({match = {class = "^(hyprland-cheatsheet)$" },                center = true})
hl.window_rule({match = {class = "^(hyprland-cheatsheet)$" },                pin = true})
